...
class ViewportPromptPrefs(bpy.types.AddonPreferences):
    ...
    def draw(self,context):
        ...
        layout.label(text="Check this box if you are a user of vim")
        layout.label(text="and would like to use :q to exit blender")
...
def register():
    print("---")
    bpy.utils.register_class(VPPROMPT_OT_vpprompt)
    bpy.utils.register_class(ViewportPromptPrefs)
    prefs = bpy.context.preferences.addons[__name__].preferences
    if prefs.map_to:
        print("prefs.map_to:",prefs.map_to)
...
def unregister():
    bpy.utils.unregister_class(VPPROMPT_OT_vpprompt)
    bpy.utils.unregister_class(ViewportPromptPrefs)
